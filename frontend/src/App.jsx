            ...
            {notes.map((note) => (
              <div key={note.id} className="note-card">
                <div className="note-header">
                  ...
                  <button onClick={() => deleteNote(note.id)} className="delete-button" title="Delete note">
                    🗑️
                  </button>
                </div>
